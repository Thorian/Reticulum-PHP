...
class Identity
{
    ...
    public static function truncatedHash($data) {
        /**
         * Get a truncated SHA-256 hash of passed data.
         *
         * @param data Data to be hashed as bytes.
         * @return Truncated SHA-256 hash as bytes.
         */
        $fullHash = hash('sha256', $data, true);
        return substr($fullHash, 0, self::TRUNCATED_HASHLENGTH / 8);
    }
    ...
    public static function getRandomHash() {
         ...
         *
         * @return Truncated SHA-256 hash of random data as bytes.
         */
        $randomData = random_bytes(self::TRUNCATED_HASHLENGTH / 8);
        return self::truncatedHash($randomData);
    }
